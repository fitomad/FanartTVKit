...
*/
public extension CollectionType where Generator.Element: FanartSeasonImage
{
    /// The diferent seasons
    public var seasonAvailables: [String]?
    {
        return Set(self.map() { $0.season }).sort()
    }
	...
	///	- Returns: A new array containing only images from this season
 	///
 	public func filterImagesBySeason(season: String) -> [Generator.Element]?
 	{
